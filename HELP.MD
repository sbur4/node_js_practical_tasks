...
docker build .
docker ps
docker run image_id => create new every time
docker stop
docker run -p -d 3000:8081 image_id(9d574dde90d4e0038e1c09c4d70a66a7febadf74496e04d988e3534f70a30efc) --rm
docker container purge (del all containers)
```